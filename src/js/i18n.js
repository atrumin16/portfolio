const translations = {
    es: {
        ...
        avail_disability_text: 'Disposición de certificado de discapacidad oficial superior al 33%. Apto para medidas de fomento del empleo, cuotas de reserva y bonificaciones fiscales a la contratación.',
        avail_join_title: 'Incorporación',
        avail_join_status: 'Disponibilidad Inmediata',
        avail_join_text: 'Listo para incorporarme de manera inmediata al equipo de trabajo y comenzar a aportar en DevOps, nube, sistemas y seguridad.',
        ...
        exp_attestto_2: 'Robustecimiento de seguridad (<strong>hardening</strong>), acceso de <strong>mínimo privilegio</strong> y respuesta ante incidentes.',
        ...
        proj_solana_desc: 'Herramienta de auditoría y análisis forense diseñada para rastrear transacciones en la blockchain de Solana. Permite la identificación de patrones sospechosos y la verificación de integridad de activos digitales, aplicando principios de ciberseguridad a entornos Web3.',
        ...
        proj_focus_desc: 'Solución de seguridad y proxy DNS gestionado diseñado para familias y pequeños negocios. Implementa un filtrado Zero-Trust en tiempo real para bloquear contenido no deseado y amenazas, desplegado sobre la infraestructura serverless de Cloudflare Workers.',
        ...
        edu_asir_title: 'Administración de Sistemas Informáticos en Red',
    ...
    ca: {
        ...
        avail_disability_text: 'Disposició de certificat de discapacitat oficial superior al 33%. Apte per a mesures de foment de l\'ocupació, quotes de reserva i bonificacions fiscals a la contractació.',
        avail_join_title: 'Incorporació',
        avail_join_status: 'Disponibilitat Immediata',
        avail_join_text: 'Llest per incorporar-me de manera immediata a l\'equip de treball i començar a aportar en DevOps, núvol, sistemes i seguretat.',
        ...
        exp_attestto_2: 'Enduriment de seguretat (<strong>hardening</strong>), aplicació de polítiques de <strong>mínim privilegi</strong> i resposta davant d\'incidents.',
        exp_attestto_3: 'Monitoratge continu de seguretat i auditoria en repositoris de codi de l\'organització.',
        ...
        proj_visit_platform: 'Visitar Plataforma',
        proj_solana_desc: 'Eina d\'auditoria i anàlisi forense dissenyada per rastrejar transaccions en la blockchain de Solana. Permet la identificació de patrons sospitosos i la verificació d\'integritat d\'actius digitals, aplicant principis de ciberseguretat a entorns Web3.',
        ...
        proj_focus_desc: 'Solució de seguretat i proxy DNS gestionat dissenyat per a famílies i petits negocis. Implementa un filtratge Zero-Trust en temps real per bloquejar contingut no desitjat i amenaces, desplegat sobre la infraestructura serverless de Cloudflare Workers.',
        proj_focus_tech: 'Cloudflare Workers, D1 Database',
        ...
        edu_title: 'Formación Académica',
        edu_asir_title: 'Administració de Sistemes Informàtics en Xarxa',
        edu_asir_level: 'Grau Superior (ASIX)',
        edu_asir_desc: 'Especialització en arquitectura de xarxes, serveis de sistema i administració de bases de dades.',
        ...
        proj_filter_devops: 'Cloud & DevOps',
        proj_filter_security: 'Ciberseguretat & Web3',
    ...
    en: {
        ...
        avail_disability_title: 'Disability >33%',
        avail_disability_text: 'Official disability certificate higher than 33%. Eligible for employment promotion measures, reserve quotas and tax bonuses for hiring.',
        avail_join_title: 'Joining',
        avail_join_status: 'Immediate Availability',
        avail_join_text: 'Ready to join the team immediately and start contributing to DevOps, cloud, systems, and security.',
        avail_schedule_title: 'Schedule Flexibility',
        ...
        exp_attestto_context: 'Cloud/IAM Infrastructure Management, Security Hardening & Digital Identity Standards (W3C DID/VC, vLEI, eIDAS)',
        exp_attestto_1: 'Cloud & identity infrastructure administration: <strong>Google Workspace/IAM, Cloudflare, GitHub, and Fly.io</strong>.',
        exp_attestto_2: 'Security hardening, enforcement of <strong>least-privilege access</strong> policies, and rapid incident response.',
        exp_attestto_3: 'Continuous security monitoring and code repository auditing across organization repositories.',
        ...
        proj_solana_desc: 'Auditing and forensic analysis tool designed to track transactions on the Solana blockchain. It allows the identification of suspicious patterns and the verification of digital asset integrity, applying cybersecurity principles to Web3 environments.',
        ...
        proj_focus_desc: 'Managed security and DNS proxy solution designed for families and small businesses. Implements real-time Zero-Trust filtering to block unwanted content and threats, deployed on Cloudflare Workers serverless infrastructure.',
        proj_focus_tech: 'Cloudflare Workers, D1 Database',
        ...
        edu_asir_title: 'Network Computer Systems Administration',
        edu_asir_level: 'Higher Degree (ASIR)',
        edu_asir_desc: 'Specialization in network architecture, system services, and database administration.',
        ...
        proj_filter_devops: 'Cloud & DevOps',
        proj_filter_security: 'Cybersecurity & Web3',
